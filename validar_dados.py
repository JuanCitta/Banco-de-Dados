    ...
    try:
        ...
        for linha in dados["disciplina"]:
            ...
            if id_departamento not in ids_departamentos:
                erros.append(f"Disciplina {id_disciplina} tem curso invalido: {id_curso}")
        ...
        for linha in dados["curso"]:
            ...
            if id_coordenador not in ids_professores:
                erros.append(f"Curso {id_curso} tem departamento invalido: {id_departamento}")
        ...
        for linha in dados["tcc"]:
            ...
            if semestre is None or str(semestre).strip() == "":
                erros.append(f"TCC {id_tcc}: semestre esta vazio")
